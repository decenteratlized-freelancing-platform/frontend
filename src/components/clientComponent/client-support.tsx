...
const faqItems = [
  {
    ...
    answer: "Navigate to the 'Post Job' section from your dashboard and fill out the project details form.",
  },
  {
    question: "How do payments work?",
    answer: "Payments are held in escrow until project milestones are completed and approved.",
  },
  {
    question: "Can I cancel a project?",
    answer: "Yes, you can cancel projects with proper notice. Refund policies apply based on project progress.",
  },
  {
    question: "How do I communicate with freelancers?",
    answer: "Use the built-in messaging system to communicate directly with your hired freelancers.",
  },
]
  ...
  return (
    <div className="max-w-4xl mx-auto px-8 py-8">
      ...
      >
        ...
        <p className="text-xl text-gray-300">Get the support you need to succeed on our platform</p>
      </motion.div>
