...
const initialGoals: Goal[] = [
  {
    ...
    description: "Achieve 50 ETH monthly recurring revenue through new client acquisitions",
    category: "Financial",
    status: "in-progress",
    progress: 65,
    ...
    priority: "high",
    milestones: [
      { id: "m1", title: "Reach 30 ETH MRR", completed: true, dueDate: "2024-06-30" },
      { id: "m2", title: "Reach 40 ETH MRR", completed: true, dueDate: "2024-09-30" },
      { id: "m3", title: "Reach 50 ETH MRR", completed: false, dueDate: "2024-12-31" },
    ],
  },
  {
    id: "2",
