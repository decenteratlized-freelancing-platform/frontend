...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      {/* Background Elements - No Gradients as requested */}
      ...
      >
        ...
        <div className="hidden lg:flex flex-col justify-between p-12 bg-zinc-900 border-r border-zinc-800">
          ...
          <div className="pt-8 border-t border-zinc-800 flex items-center justify-between">
            {/* <span className="text-xs text-zinc-600 font-medium uppercase tracking-widest">v2.0 Blockchain Powered</span> */}
            <div className="flex gap-4 text-zinc-600">
              <span className="hover:text-white transition-colors cursor-pointer text-xs">Privacy</span>
              <span className="hover:text-white transition-colors cursor-pointer text-xs">Terms</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 sm:p-12 bg-zinc-950 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            <div className="lg:hidden flex justify-center mb-8 bg-zinc-950">
            ...
            {viewState !== 'forgot' && (
              <div className="flex flex-col sm:flex-row gap-3 mb-8">
                <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-zinc-900 border border-zinc-800 rounded-xl hover:border-zinc-600 transition-all text-sm font-semibold"
                >
