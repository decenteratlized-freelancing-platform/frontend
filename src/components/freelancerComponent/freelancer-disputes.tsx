    ...
    return (
        <div className="max-w-7xl mx-auto px-8 py-8">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
                <div className="inline-flex items-center gap-2 bg-orange-500/10 backdrop-blur-sm border border-orange-500/20 rounded-full px-6 py-3 mb-6">
                    <Shield className="w-4 h-4 text-orange-400" />
                    <span className="text-sm font-bold uppercase tracking-widest text-orange-400">Dispute Resolution</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 tracking-tight">Case <span className="text-orange-400">History</span></h1>
                                        ...
                                        >
                                            <div className="flex items-center justify-between gap-6">
                                                <div className="flex items-center gap-6 flex-1">
                                                    <div className={`w-12 h-12 ${isRaisedByMe ? "bg-orange-500/10 border-orange-500/20" : "bg-blue-500/10 border-blue-500/20"} rounded-2xl flex items-center justify-center border group-hover:scale-110 transition-transform`}>
                                                        {isRaisedByMe ? <AlertTriangle className="w-6 h-6 text-orange-400" /> : <Shield className="w-6 h-6 text-blue-400" />}
                                                    </div>
                                                    <div className="space-y-1">
                                                        <div className="flex items-center gap-3">
                                                            <p className="font-bold text-lg text-white group-hover:text-orange-400 transition-colors">{dispute.job?.title}</p>
                                                            <Badge variant="outline" className={`text-[10px] font-black uppercase tracking-widest ${isRaisedByMe ? "border-orange-400/50 text-orange-400" : "border-blue-400/50 text-blue-400"}`}>
                                                                {isRaisedByMe ? "Petitioner" : "Respondent"}
                                                            </Badge>
                                                        </div>
                            ...
                            <div className="p-8 border-b border-zinc-800/50 bg-white/5">
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="flex flex-col items-end gap-2">
                                        <Link href={`/freelancer/contracts/${selectedDispute.contract?._id}`}>
                                                ...
                                                <div className="p-4 bg-zinc-950 border-t border-zinc-800/50">
                                                    <div className="flex gap-2 bg-zinc-900 border border-zinc-800 rounded-2xl p-1.5 focus-within:border-zinc-700 transition-colors">
                                                        ...
                                                        <Button 
                                                            ...
                                                            size="icon" 
                                                            className="bg-orange-500 hover:bg-orange-600 rounded-xl h-10 w-10 shrink-0"
                                                        >
